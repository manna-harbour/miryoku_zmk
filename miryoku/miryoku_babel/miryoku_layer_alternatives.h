...
U_MT(LGUI, A),     U_MT(LALT, S),     U_MT(LCTRL, D),    U_MT(LSHFT, F),    &kp G,             &kp H,             U_MT(LSHFT, J),    U_MT(LCTRL, K),    U_MT(LALT, L),     U_MT(LGUI, SQT),   \
U_LT(U_BUTTON, Z), U_MT(RALT, X),     &kp C,             &kp V,             &kp B,             &kp N,             &kp M,             &kp COMMA,         U_MT(RALT, DOT),   U_LT(U_BUTTON, SLASH),\
U_NP,              U_LT(U_ITA, ESC),  U_LT(U_MEDIA, ESC),U_LT(U_NAV, TAB),  U_LT(U_MOUSE, SPACE),U_LT(U_SYM, RET),  U_LT(U_NUM, BSPC), U_LT(U_FUN, DEL),  U_NP,              U_LT(U_ITA, ESC)
...
U_NA,              U_NA,             &ac_eacu,           U_NA,              U_NA,              U_NA,              &ac_uacu,          &ac_iacu,         &ac_oacu,           U_NA,              \
...
U_NA,              U_NA,             &ac_eacu,           U_NA,              U_NA,              U_NA,              &ac_uacu,          &ac_iacu,         &ac_oacu,           U_NA,              \
&ac_aacu,          U_NA,             U_NA,               &kp RSHFT,         U_NA,              U_NA,              &kp RSHFT,         U_NA,             U_NA,               U_NA,              \
U_NA,              U_NA,             U_NA,               U_NA,              U_NA,              U_NA,              U_NA,              U_NA,             U_NA,               U_NA,              \
U_NP,              U_NP,             U_NA,               U_NA,              U_NA,              U_NA,              U_NA,              U_NA,             U_NP,               U_NP
