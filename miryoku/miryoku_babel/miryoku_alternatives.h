...
U_NU,              U_NU,              &kp KP_N8,         U_NU,              U_NU,              U_NA,              U_NA,              U_NA,              U_NA,              &bootloader,       \
U_NU,              &kp KP_N4,         &kp KP_N2,         &kp KP_N6,         U_NU,              U_NA,              &kp LSHFT,         &kp LCTRL,         &kp LALT,          &kp LGUI,          \
U_UND,             U_CUT,             U_CPY,             U_PST,             U_RDO,             U_NA,              U_NA,              U_NA,              &kp RALT,          U_NA,              \
U_NP,              U_NP,              U_NU,              U_NU,              &kp KP_N5,         U_NA,              U_NA,              U_NA,              U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_MOUSE_FLIP \
U_NU,              U_NU,              U_NU,              U_NU,              U_NU,              U_NA,              U_NA,              U_NA,              U_NA,              &bootloader,       \
&kp KP_N4,         &kp KP_N2,         &kp KP_N8,         &kp KP_N6,         U_NU,              U_NA,              &kp LSHFT,         &kp LCTRL,         &kp LALT,          &kp LGUI,          \
U_UND,             U_CUT,             U_CPY,             U_PST,             U_RDO,             U_NA,              U_NA,              U_NA,              &kp RALT,          U_NA,              \
U_NP,              U_NP,              U_NU,              U_NU,              &kp KP_N5,         U_NA,              U_NA,              U_NA,              U_NP,              U_NP
...
&bt BT_SEL 0,      &bt BT_SEL 1,      &kp C_VOL_UP,      &bt BT_SEL 2,      &bt BT_SEL 3,      U_NA,              U_NA,              U_NA,              U_NA,              &bootloader,       \
&bt BT_CLR,        &kp C_PREV,        &kp C_VOL_DN,      &kp C_NEXT,        &out OUT_TOG,      U_NA,              &kp LSHFT,         &kp LCTRL,         &kp LALT,          &kp LGUI,          \
&rgb_ug RGB_EFF,   &rgb_ug RGB_HUI,   &rgb_ug RGB_SAI,   &rgb_ug RGB_BRI,   &rgb_ug RGB_TOG,   U_NA,              U_NA,              U_NA,              &kp RALT,          U_NA,              \
