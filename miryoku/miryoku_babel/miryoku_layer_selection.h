...
#if !defined(MIRYOKU_LAYER_ITA)
  #if defined (MIRYOKU_LAYERS_FLIP)
    #define MIRYOKU_LAYER_ITA MIRYOKU_ALTERNATIVES_ITA_FLIP
  #else
    #define MIRYOKU_LAYER_ITA MIRYOKU_ALTERNATIVES_ITA
  #endif
#endif
#if !defined(MIRYOKU_LAYERMAPPING_ITA)
  #define MIRYOKU_LAYERMAPPING_ITA MIRYOKU_MAPPING
#endif