...
#include "miryoku_layer_alternatives.h"
    ...
    #elif defined (MIRYOKU_ALPHAS_DSEND)
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_DSEND_FLIP
    ...
    #elif defined (MIRYOKU_ALPHAS_DSEND)
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_DSEND
    #elif defined (MIRYOKU_ALPHAS_DVORAK)
  ...
  #define MIRYOKU_LAYERMAPPING_BASE MIRYOKU_MAPPING
    ...
    #elif defined (MIRYOKU_EXTRA_DSEND)
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_DSEND_FLIP
    ...
    #elif defined (MIRYOKU_EXTRA_DSEND)
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_DSEND
    #elif defined (MIRYOKU_EXTRA_DVORAK)
  ...
  #define MIRYOKU_LAYERMAPPING_EXTRA MIRYOKU_MAPPING
    ...
    #elif defined (MIRYOKU_TAP_DSEND)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_TAP_DSEND_FLIP
    ...
    #elif defined (MIRYOKU_TAP_DSEND)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_TAP_DSEND
    #elif defined (MIRYOKU_TAP_DVORAK)
