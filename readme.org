...
Specify if the board or shield requires one or more snippets. Use is the same as for the workflow [[#snippets][snippets]] option. 

If snippets are also specified via the workflow ~snippets~ option or in other outboards, all snippets will be used.
